"""
Train a behavior-cloning MLP policy on collected demonstrations.

Usage:
    python scripts/train_bc.py --demos demos/stage1_demos.npz --out checkpoints/bc_stage1.pt
"""
...
def main():
    ...
    parser.add_argument("--out", type=str, default="checkpoints/bc_stage1.pt")
    ...
    model = BCPolicy(obs_dim=obs.shape[1], act_dim=actions.shape[1],
                      hidden=args.hidden)
